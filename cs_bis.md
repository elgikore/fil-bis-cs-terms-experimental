...
* **Pagpailahon** = Authentication
    * Lit. Act of causing (establish/acknowledge; *pagpa-*) a recognition (ila) on a place (*-on*)
* **Pagpahinulubagon** / **Awtorisasyon** = Authorization   
...
* **Diadresnulo** = Not Null
    * *Di-* + Adres + nulo
* **Adrespabilin** = Dangling Pointer
    * Adres + pabilin
    * Lit. "Left behind address"
* **Adres-Dipanatukod** / **Di-panatukod Adres** = Uninitialized Pointer
    * Adres + *di-* + *pa-* + *na-* + tukod
* **Adrespinadayon** = Use-after-Free
    * Adres + *pina-* + dayon
    * Because you use the address again (pinadayon) even if it is already freed
...
* **Sangpayruhan** = Physical Drive / HDD / SSD
    * Borrowed from Filipino since *dak-* doesn't really fit semantics because it is not just big in scale
* **Sangpayruhang Giplakahan** = Hard Disk Drive
    * *Gi- -han* because it was done/applied on a place (focus on location)
* **Sangpayruhang Gisilikahan** = Solid State Drive
    * *Gi- -han* because it was done/applied on a place (focus on location)
    * Silika was used because SSDs are made of ICs, and ICs are finished with silicon. Using sangpayruhan as base disambiguates regular silicon
...
* **Pagpamodelong Estraktural** / **Pagpamodelong Pangestraktura** = Architectual Modelling
* **Pagpatantyang Pangsoftware** / **Pagpatanchang Pangsoftware** = Software Estimation
...
* **Probabilidadong Pagpahalili** = Multiple Imputation
...
* **Ngariang Dinasukod** / **Eror Natural** / **Error Natural** = Irreducible Error
    * Ngarian = In the bone / Deeply ingrained or inherent; borrowed from Filipino
...
* **Regresyon** = Regression (Generic Sense)
    * Transliteration
* **Pagpasentrosentro** / **Regresyon** = Regression (Classical Statistics Sense)
    * Pagpasentrosentro is based on "regression towards the mean" definition
...
* **Pagtuki sa Pagkaalanganin** / **Alanganintuki** / **Pagpaalanganintuki** = Sensitivity Analysis
...
* **Pangadresbirtwal-pisikal** / **Talablokehan** = Page Table
    ...
    * Bloke = Page
* **Tigpanghitunga-birtwal** / **Tigpanghitungamertwal** = Virtual Machine Control Structure
    * Tigpatunga/patunga/tunga is used simply because a VMCS is a mediator between Hypervisor and Guest OS's states
